...
import "github.com/XCWeaver/xcweaver/runtime/version"
...
// binary.
//
// It is best explained via an example. Imagine 'xcweaver generate' is running
// with codegen version 0.1.0. For every package, 'xcweaver generate' generates
// the following line:
//
